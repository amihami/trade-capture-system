...
export const searchTradesBySettlement = (q: string) =>
  api.get("/trades/search/settlement-instructions", {
    params: { instructions: q },
  });
export const fetchTradeById = (id: number | string) => api.get(`/trades/${id}`);
